...
//[.anns]
//== Announcements
//* *Final Exam*: self-scheduled, 3 hours, open book/laptop, link:https://www.brynmawr.edu/access-services/students/procedures-and-schedules-final-exams-fall-2021[See here for details]
...
image:Labs/slerpTeapot.gif[width=300px]
|.Bezier curves
image:Labs/screensaver.gif[width=300px]
|.Non-human characters
image:Labs/butterfly.gif[width=300px]
|.Squirrel paper doll based on forward kinematics.
image:Labs/squirrel.png[width=300px]
|.Characters based on motion capture and hierarchical transformations.
image:Labs/characters.gif[width=300px]
|.Animations based on inverse kinematics
image:Labs/dancer5.gif[width=300px]
|.Crowds based on physically-based steering and flocking behaviors
image::Labs/leader.gif[width=300px]
|.Physics-based simulation
image:Labs/wallPhysics.gif[width=300px]
|.Motion blending, warping and splicing
image:Labs/splice-gangnam-walk.gif[width=300px]
|===
