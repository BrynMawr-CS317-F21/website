...
|14
|Nov 39, Dec 2
|*Character animation tools* anchor:week14[]

Motion capture. Tools for character modeling, skinning, and keyframing.
...
* link:https:https://www.unrealengine.com/en-US/[Unity]
