...
* *Assignment 06:* link:asst06-transform.html[Building character]: *Due Oct 28*
...
More Articulated Characters. Tree traversal review.
Motion. Motion Representation. Motion Capture. Procedural animation.
