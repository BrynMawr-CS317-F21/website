...
:title: Assignment 8: The cross-fade away
:Author Initials: ASN
:Date:    2020-02-07
:Revision: 0.1
...
* TODO: Use `glm::slerp` to blend local rotations for the upper body
* Use the sequence of poses from upper starting at key ID = 120
