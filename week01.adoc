...
Try the sample problems link:math-self-assessment.html#trig[here]. 
...
Try the sample problems link:math-self-assessment.html#vector[here]. 

* coordinate systems: axes, origin, stem:[\hat{i}, \hat{j}, \hat{k}]
...
Try the sample problems link:math-self-assessment.html#matrix[here]. 
...
Try the sample problems link:math-self-assessment.html#poly[here]. 

* Degree
* Manipulating expressions (algebra)
