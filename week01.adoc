...
https://www.khanacademy.org/math/algebra-home/alg-matrices/alg-intro-to-matrix-inverses/v/inverse-matrix-part-1
...
Take this link:MathSelfAssessment.pdf[Math Self-Assessment Quiz] to check whether you should brush up 
on some skills!
